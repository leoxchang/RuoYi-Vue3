...
public interface ISysDeptService {
     ...
     * @return 部门信息集合
     */
    Page<SysDeptDTO> selectDeptList(SysDeptParam deptParam);
     ...
     * @return 部门树信息集合
     */
    List<TreeSelect> selectDeptTreeList(SysDeptParam deptParam);
     ...
     * @return 结果
     */
    int insertDept(SysDeptParam deptParam);
     ...
     * @return 结果
     */
    int updateDept(SysDeptUpdateParam deptUpdateParam);
