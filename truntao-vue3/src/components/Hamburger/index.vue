<template>
  <div style="padding: 0 15px;" @click="toggleClick">
    <svg :class="{ 'is-active': true }" class="hamburger" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"
         width="64" height="64">
      <path
...
import type {HamburgerProps, HamburgerEmits} from './index.d';

withDefaults(defineProps<HamburgerProps>(), {
  isActive: false
});

const emit = defineEmits<HamburgerEmits>();
