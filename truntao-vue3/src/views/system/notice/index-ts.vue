<template>
    <div class="app-container">
        ...
        <!-- 添加或修改公告对话框 -->
        <el-dialog :title="title" v-model="open" width="780px" :modal-append-to-body="false">
...
const data = reactive({
    ...
    queryParams: {
        pageNum: 1,
        pageSize: 10,
        noticeTitle: undefined as any,
        createBy: undefined as any,
        status: undefined as any,
        noticeType: undefined as any,
    },
    rules: {
...
function reset() {
    form.value = {
        noticeId: undefined as any,
        noticeTitle: undefined as any,
        noticeType: undefined as any,
        noticeContent: undefined as any,
        status: "0"
    };
