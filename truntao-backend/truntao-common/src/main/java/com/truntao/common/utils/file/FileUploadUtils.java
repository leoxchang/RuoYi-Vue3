package com.truntao.common.utils.file;
...
import com.truntao.common.exception.file.FileNameLengthLimitExceededException;
import com.truntao.common.exception.file.FileSizeLimitExceededException;
import com.truntao.common.exception.file.InvalidExtensionException;
import com.truntao.common.utils.DateUtils;
import com.truntao.common.utils.uuid.Seq;
...
public class FileUploadUtils {
     ...
     */
    @Getter
    private static String defaultBaseDir = TruntaoConfig.getProfile();
    ...
    public static File getAbsoluteFile(String fileName) {
        File desc = new File(getDefaultBaseDir() + File.separator + fileName);
    ...
    public static String getPathFileName(String uploadDir, String fileName) {
        int dirLastIndex = TruntaoConfig.getProfile().length() + 1;
