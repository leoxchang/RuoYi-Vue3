...
public class GenConstants {
     ...
     * 数据库时间类型
     */
    public static final String[] COLUMN_TYPE_TIME = {DATE_TIME, "time", "date", "timestamp"};
     ...
     * Entity基类字段
     */
    public static final String[] BASE_ENTITY = {CREATE_BY, CREATE_TIME, DEL_FLAG, UPDATE_BY,
            UPDATE_TIME, REMARK};
