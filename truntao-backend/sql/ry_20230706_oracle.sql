...
create table sys_dept (
  dept_id           number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 200 increment by 1 nocache nomaxvalue nominvalue,
...
create table sys_user (
  user_id           number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
(
  post_id           number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 10 increment by 1 nocache nomaxvalue nominvalue,
...
create table sys_role (
  role_id              number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
create table sys_menu (
  menu_id           number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 2000 increment by 1 nocache nomaxvalue nominvalue,
...
comment on column sys_menu.router_name  is '路由名称';
...
insert into sys_menu values('107',  '信息发布', '1',   '8', 'notice',     'system/notice/index',      '', '', 1, 0, 'C', '0', '0', 'system:notice:list',      'message',       'admin', sysdate, '', null, '信息发布菜单');
...
insert into sys_menu values('501',  '登录日志', '108', '2', 'logininfor', 'monitor/logininfo/index', '', 1, 0, 'C', '0', '0', 'monitor:logininfo:list', 'logininfo',    'admin', sysdate, '', null, '登录日志菜单');
-- 用户管理按钮
...
-- 信息发布按钮
insert into sys_menu values('1035', '信息发布查询', '107', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:notice:query',        '#', 'admin', sysdate, '', null, '');
insert into sys_menu values('1036', '信息发布新增', '107', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:notice:add',          '#', 'admin', sysdate, '', null, '');
insert into sys_menu values('1037', '信息发布修改', '107', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:notice:edit',         '#', 'admin', sysdate, '', null, '');
insert into sys_menu values('1038', '信息发布删除', '107', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:notice:remove',       '#', 'admin', sysdate, '', null, '');
-- 操作日志按钮
...
create table sys_oper_log (
  oper_id           number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
(
  dict_id           number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
(
  dict_code        number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
insert into sys_dict_data values(14, 1,  '通知',     '1',       'sys_notice_type',     '',   'warning', 'Y', '0', 'admin', sysdate, '', null, '信息发布类型');
insert into sys_dict_data values(15, 2,  '简报',     '2',       'sys_notice_type',     '',   'success', 'N', '0', 'admin', sysdate, '', null, '信息发布类型');
insert into sys_dict_data values(16, 3,  '批复',     '3',       'sys_notice_type',     '',   'primary', 'N', '0', 'admin', sysdate, '', null, '信息发布类型');
insert into sys_dict_data values(17, 4,  '标准',     '4',       'sys_notice_type',     '',   'info', 'N', '0', 'admin', sysdate, '', null, '信息发布类型');
insert into sys_dict_data values(18, 5,  '其他',     '5',       'sys_notice_type',     '',   'danger', 'N', '0', 'admin', sysdate, '', null, '信息发布类型');
insert into sys_dict_data values(19, 1,  '未发布',     '0',       'sys_notice_status',   '',   'primary', 'Y', '0', 'admin', sysdate, '', null, '信息发布状态');
insert into sys_dict_data values(20, 2,  '发布中',     '1',       'sys_notice_status',   '',   'info',  'N', '0', 'admin', sysdate, '', null, '信息发布状态');
insert into sys_dict_data values(21, 3,  '已过期',     '2',       'sys_notice_status',   '',   'danger',  'N', '0', 'admin', sysdate, '', null, '信息发布状态');
insert into sys_dict_data values(22, 99, '其他',     '0',       'sys_oper_type',       '',   'info',    'N', '0', 'admin', sysdate, '', null, '其他操作');
insert into sys_dict_data values(23, 1,  '新增',     '1',       'sys_oper_type',       '',   'info',    'N', '0', 'admin', sysdate, '', null, '新增操作');
insert into sys_dict_data values(24, 2,  '修改',     '2',       'sys_oper_type',       '',   'info',    'N', '0', 'admin', sysdate, '', null, '修改操作');
insert into sys_dict_data values(25, 3,  '删除',     '3',       'sys_oper_type',       '',   'danger',  'N', '0', 'admin', sysdate, '', null, '删除操作');
insert into sys_dict_data values(26, 4,  '授权',     '4',       'sys_oper_type',       '',   'primary', 'N', '0', 'admin', sysdate, '', null, '授权操作');
insert into sys_dict_data values(27, 5,  '导出',     '5',       'sys_oper_type',       '',   'warning', 'N', '0', 'admin', sysdate, '', null, '导出操作');
insert into sys_dict_data values(28, 6,  '导入',     '6',       'sys_oper_type',       '',   'warning', 'N', '0', 'admin', sysdate, '', null, '导入操作');
insert into sys_dict_data values(29, 7,  '强退',     '7',       'sys_oper_type',       '',   'danger',  'N', '0', 'admin', sysdate, '', null, '强退操作');
insert into sys_dict_data values(30, 8,  '生成代码', '8',       'sys_oper_type',       '',   'warning', 'N', '0', 'admin', sysdate, '', null, '生成操作');
insert into sys_dict_data values(31, 9,  '清空数据', '9',       'sys_oper_type',       '',   'danger',  'N', '0', 'admin', sysdate, '', null, '清空操作');
...
create table sys_config (
  config_id         number(20)     GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
create table sys_login_info (
  info_id         number(20)     GENERATED BY DEFAULT AS IDENTITY start WITH 200 increment by 1 nocache nomaxvalue nominvalue,
...
create table sys_job (
  job_id              number(20)     GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
create table sys_job_log (
  job_log_id          number(20)       GENERATED BY DEFAULT AS IDENTITY start WITH 1 increment by 1 nocache nomaxvalue nominvalue,
...
create table sys_notice (
  notice_id         number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
comment on table  sys_notice                   is '信息发布表';
comment on column sys_notice.notice_id         is '信息发布主键seq_sys_notice.nextval';
comment on column sys_notice.notice_title      is '信息发布标题';
comment on column sys_notice.notice_type       is '信息发布类型（1通知 2公告）';
comment on column sys_notice.notice_content    is '信息发布内容';
comment on column sys_notice.status            is '信息发布状态（0未发布 1发布中2已过期）';
comment on column sys_notice.create_by         is '创建者';
comment on column sys_notice.create_time       is '创建时间';
comment on column sys_notice.publish_time       is '发布时间';
comment on column sys_notice.expire_time       is '过期时间';
comment on column sys_notice.scroll_expire_time  is '滚动过期时间';
...
create table gen_table (
  table_id          number(20)       GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
...
create table gen_table_column (
  column_id         number(20)      GENERATED BY DEFAULT AS IDENTITY start WITH 100 increment by 1 nocache nomaxvalue nominvalue,
  table_id          number(20),
